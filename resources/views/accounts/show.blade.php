...
@section('content')
    ...
    <div class="mb-6 grid gap-4 md:grid-cols-3">
        <div class="rounded-2xl bg-white p-5 shadow-sm"><div class="text-sm text-slate-500">Borç</div><div class="mt-2 text-2xl font-bold">{{ number_format($debit, 2, ',', '.') }} TL</div></div>
        <div class="rounded-2xl bg-white p-5 shadow-sm"><div class="text-sm text-slate-500">Alacak</div><div class="mt-2 text-2xl font-bold">{{ number_format($credit, 2, ',', '.') }} TL</div></div>
        <div class="rounded-2xl bg-white p-5 shadow-sm"><div class="text-sm text-slate-500">Bakiye</div><div class="mt-2 text-2xl font-bold">{{ number_format(abs($debit - $credit), 2, ',', '.') }} TL</div></div>
    </div>
